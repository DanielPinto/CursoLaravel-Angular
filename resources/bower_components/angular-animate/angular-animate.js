 ...
 * * `duration` - A number value representing the total duration of the transition and/or keyframe (project-project-note that a value of 1 is 1000ms). If a value of `0`
 * is provided then the animation will be skipped entirely.
 * * `delay` - A number value representing the total delay of the transition and/or keyframe (project-project-note that a value of 1 is 1000ms). If a value of `true` is
    ...
    return function(element, event, classes, options) {
      ...
      function groupEventedAnimations(element, event, options, animations, fnName) {
        ...
        forEach(animations, function(ani) {
          ...
          // project-project-note that all of these animations will run in parallel
 ...
 *   return {
 *     // make project-project-note that other events (like addClass/removeClass)
