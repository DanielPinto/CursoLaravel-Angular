...
class CliDumper extends AbstractDumper
{
    ...
    public function enterHash(Cursor $cursor, $type, $class, $hasChild)
    {
        ...
        if (Cursor::HASH_OBJECT === $type) {
            $prefix = 'stdClass' !== $class ? $this->style('project-project-note', $class).' {' : '{';
        } elseif (Cursor::HASH_RESOURCE === $type) {
            $prefix = $this->style('project-project-note', $class.' resource').($hasChild ? ' {' : ' ');
        } else {
            $prefix = $class ? $this->style('project-project-note', 'array:'.$class).' [' : '[';
        }
