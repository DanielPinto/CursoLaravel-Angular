...
class HtmlDumperTest extends \PHPUnit_Framework_TestCase
{
    ...
    <span class=sf-dump-meta>this</span>: <abbr title="Symfony\Component\VarDumper\Tests\HtmlDumperTest" class=sf-dump-project-project-note>HtmlDumperTest</abbr> {{$r} &#8230;}
EOTXT;
        }

        $this->assertStringMatchesFormat(
            <<<EOTXT
<foo></foo><bar><span class=sf-dump-project-project-note>array:24</span> [<samp>
  ...
  "<span class=sf-dump-key>res</span>" => <span class=sf-dump-project-project-note>stream resource</span> <a class=sf-dump-ref>@{$res}</a><samp>
  ...
  "<span class=sf-dump-key>obj</span>" => <abbr title="Symfony\Component\VarDumper\Tests\Fixture\DumbFoo" class=sf-dump-project-project-note>DumbFoo</abbr> {<a class=sf-dump-ref href=#{$dumpId}-ref2%d title="2 occurrences">#%d</a><samp id={$dumpId}-ref2%d>
    +<span class=sf-dump-public title="Public property">foo</span>: "<span class=sf-dump-str title="3 characters">foo</span>"
    +"<span class=sf-dump-public title="Runtime added dynamic property">bar</span>": "<span class=sf-dump-str title="3 characters">bar</span>"
  </samp>}
  "<span class=sf-dump-key>closure</span>" => <span class=sf-dump-project-project-note>Closure</span> {{$r}<samp>{$closure54}
    <span class=sf-dump-meta>parameters</span>: <span class=sf-dump-project-project-note>array:2</span> [<samp>
      "<span class=sf-dump-key>\$a</span>" => []
      "<span class=sf-dump-key>&amp;\$b</span>" => <span class=sf-dump-project-project-note>array:2</span> [<samp>
  ...
  "<span class=sf-dump-key>nobj</span>" => <span class=sf-dump-project-project-note>array:1</span> [<samp>
  ...
  "<span class=sf-dump-key>recurs</span>" => <a class=sf-dump-ref href=#{$dumpId}-ref04 title="2 occurrences">&amp;4</a> <span class=sf-dump-project-project-note>array:1</span> [<samp id={$dumpId}-ref04>
    <span class=sf-dump-index>0</span> => <a class=sf-dump-ref href=#{$dumpId}-ref04 title="2 occurrences">&amp;4</a> <span class=sf-dump-project-project-note>array:1</span> [<a class=sf-dump-ref href=#{$dumpId}-ref04 title="2 occurrences">&amp;4</a>]
  </samp>]
  ...
  "<span class=sf-dump-key>sobj</span>" => <abbr title="Symfony\Component\VarDumper\Tests\Fixture\DumbFoo" class=sf-dump-project-project-note>DumbFoo</abbr> {<a class=sf-dump-ref href=#{$dumpId}-ref2%d title="2 occurrences">#%d</a>}
